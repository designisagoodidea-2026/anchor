...
Diff records from [[layer-5-diff-memory]]. Leader voice profile from `/voice-profiles/<leader-handle>.md`.
...
The profile carries (see [[../memory/anchor-voice-profile-schema]] for the full schema):
...
See [[../memory/anchor-voice-profile-schema]].

## First profile

See [[../memory/anchor-voice-profile-jason]]. The Jason profile is the v0.1 demonstration of the layer.
...
Per [[../memory/anchor-open-decisions]], the dual adapter abstracts over the surface. The renderer writes to whichever the leader configured at setup. Two reference implementations.
...
- [[layer-5-diff-memory]] — produces input.
- [[../memory/anchor-voice-profile-schema]] — schema spec.
- [[../memory/anchor-voice-profile-jason]] — first profile.
- [[../memory/anchor-feedback-disliked-words]] — banned vocabulary list.
- [[../memory/anchor-feedback-paragraph-spacing]] — craft rules.
- [[../memory/anchor-feedback-curious-not-credentialing]] — framing rules and pushback triggers.
- [[../memory/anchor-feedback-no-company-attribution]] — framing rule.
- [[../memory/anchor-feedback-no-generic-outputs]] — specificity rule.
