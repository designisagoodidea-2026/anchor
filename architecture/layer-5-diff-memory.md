...
The leader marks digest items right / wrong / noise; the system adjusts kind weights and signal weights per-leader. v0.1 is one-way (system → leader). See [open decisions](../docs/anchor-open-decisions.md).
